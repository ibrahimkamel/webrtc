...
{
    constructor(userName, channelName, pcConfig, startCallBtn, endCallBtn, muteCallBtn, localVideoDiv, remoteVideoDiv,
        callType)
    {
    ...
    setLocalAndSendMessageData(sessionDescription)
    {
